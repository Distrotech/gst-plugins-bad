...
DIST_COMMON = $(top_srcdir)/common/win32.mak \
	...
	$(top_srcdir)/win32/common/config.h.in ABOUT-NLS COPYING \
	COPYING.LIB compile config.guess config.rpath config.sub \
...
CONFIG_CLEAN_FILES = gst-plugins-bad.spec win32/common/config.h
...
ACLOCAL = ${SHELL} /usr/src/gst-plugins-bad/gst-plugins-bad/missing aclocal-1.14
...
ASSRENDER_LIBS = -lass  
AUTOCONF = ${SHELL} /usr/src/gst-plugins-bad/gst-plugins-bad/missing autoconf
AUTOHEADER = ${SHELL} /usr/src/gst-plugins-bad/gst-plugins-bad/missing autoheader
AUTOMAKE = ${SHELL} /usr/src/gst-plugins-bad/gst-plugins-bad/missing automake-1.14
AWK = gawk
BZ2_LIBS = -lbz2
CC = gcc -std=gnu99
CCASFLAGS = 
...
GST_CFLAGS = -pthread -I/usr/include/gstreamer-0.10 -I/usr/include/glib-2.0 -I/usr/lib/glib-2.0/include -I/usr/include/libxml2    -DG_THREADS_MANDATORY -DG_DISABLE_CAST_CHECKS -DG_DISABLE_ASSERT $(GST_OPTION_CFLAGS)
...
GST_CURRENT = 23
GST_CXXFLAGS = -pthread -I/usr/include/gstreamer-0.10 -I/usr/include/glib-2.0 -I/usr/lib/glib-2.0/include -I/usr/include/libxml2    -DG_THREADS_MANDATORY -DG_DISABLE_CAST_CHECKS -DG_DISABLE_ASSERT $(GST_OPTION_CXXFLAGS)
...
GST_PLUGINS_ALL =  adpcmdec adpcmenc aiff asfmux audiovisualizers autoconvert bayer camerabin camerabin2 cdxaparse coloreffects colorspace dataurisrc dccp debugutils dtmf dvbsuboverlay dvdspu faceoverlay festival fieldanalysis freeze freeverb frei0r gaudieffects geometrictransform h264parse hdvparse hls id3tag inter interlace ivfparse jp2kdecimator jpegformat legacyresample librfb liveadder mpegdemux mpegtsdemux mpegtsmux mpegpsmux mpegvideoparse mve mxf nsf nuvdemux patchdetect pcapparse pnm rawparse real removesilence rtpmux rtpvp8 scaletempo sdi sdp segmentclip siren smooth speed subenc stereo tta videofilters videomaxrate videomeasure videoparsers videosignal vmnc y4m
...
GTK_CFLAGS = -pthread -I/usr/X11R7/include/pixman-1 -I/usr/X11R7/include -I/usr/include/gtk-2.0 -I/usr/lib/gtk-2.0/include -I/usr/include/atk-1.0 -I/usr/include/cairo -I/usr/include/gdk-pixbuf-2.0 -I/usr/include/pango-1.0 -I/usr/include/glib-2.0 -I/usr/lib/glib-2.0/include -I/usr/include/freetype2 -I/usr/include/libpng16 -I/usr/include/harfbuzz -I/usr/include/libpng15  
GTK_LIBS = -lgtk-x11-2.0 -lgdk-x11-2.0 -latk-1.0 -lgio-2.0 -lpangocairo-1.0 -lgdk_pixbuf-2.0 -lcairo -lpangoft2-1.0 -lpango-1.0 -lm -lfreetype -lfontconfig -lgobject-2.0 -lglib-2.0  
HAVE_BZ2 = yes
HAVE_CXX = yes
HAVE_DIRECT3D = no
HAVE_DIRECTDRAW = no
...
LTLIBOBJS = 
MAINT = 
MAKEINFO = ${SHELL} /usr/src/gst-plugins-bad/gst-plugins-bad/missing makeinfo
MANIFEST_TOOL = :
MIMIC_CFLAGS = 
MIMIC_LIBS = 
MJPEG_CFLAGS = 
...
PYTHON_VERSION = 2.7
RANLIB = ranlib
RSVG_CFLAGS = -pthread -I/usr/X11R7/include/pixman-1 -I/usr/X11R7/include -I/usr/include/librsvg-2.0 -I/usr/include/glib-2.0 -I/usr/lib/glib-2.0/include -I/usr/include/gdk-pixbuf-2.0 -I/usr/include/cairo -I/usr/include/libpng15 -I/usr/include/freetype2 -I/usr/include/libpng16  
RSVG_LIBS = -lrsvg-2 -lm -lgio-2.0 -lgdk_pixbuf-2.0 -lgobject-2.0 -lglib-2.0 -lcairo  
RTMP_CFLAGS =  
RTMP_LIBS = -lrtmp -lz -lssl -lcrypto  
...
SOUNDTOUCH_LIBS = 
SPANDSP_CFLAGS =  
SPANDSP_LIBS = -lspandsp -ltiff -lm  
SPC_LIBS = 
STRIP = strip
SWFDEC_CFLAGS = 
SWFDEC_LIBS = 
...
VALGRIND_LIBS = 
VALGRIND_PATH = no
VDPAU_CFLAGS = -I/usr/X11R7/include  
VDPAU_LIBS = -lvdpau
VERSION = 0.10.23
VOAACENC_CFLAGS =  
...
ZBAR_CFLAGS = 
ZBAR_LIBS = 
abs_builddir = /usr/src/gst-plugins-bad/gst-plugins-bad
abs_srcdir = /usr/src/gst-plugins-bad/gst-plugins-bad
abs_top_builddir = /usr/src/gst-plugins-bad/gst-plugins-bad
abs_top_srcdir = /usr/src/gst-plugins-bad/gst-plugins-bad
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /usr/src/gst-plugins-bad/gst-plugins-bad/install-sh
...
gst-plugins-bad.spec: $(top_builddir)/config.status $(srcdir)/gst-plugins-bad.spec.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
win32/common/config.h: $(top_builddir)/config.status $(top_srcdir)/win32/common/config.h.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
...
check-exports:
	...
	for l in $(win32defs); do \
	  ...
	  libso=`find "$(top_builddir)" -name "$$libbase-0.10.so" | grep -v /_build/ | head -n1`; \
